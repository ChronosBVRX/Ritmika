...
const PHRASES = {
  ...
  "genre_reggaeton_10": "¡Hasta Yandel se asustó con ese perreo!",
  "genre_reggaeton_11": "¡Esa nota estuvo más abajo que el subsuelo, rey!",
  "genre_reggaeton_12": "¡Le metiste más autotune que J Balvin en concierto!",
  "genre_reggaeton_13": "¡Con ese flow no pasas ni del casting de Venga la Alegría!",
  "genre_reggaeton_14": "¡Te faltó calle, perro, pero sobró actitud!",
  "genre_banda_10": "¡Julión Álvarez te mandó bloquear de WhatsApp!",
  "genre_banda_11": "¡Parece que estabas arreando vacas en vez de cantar!",
  "genre_banda_12": "¡Esa trompeta sonó a elefante constipado!",
  "genre_banda_13": "¡Ni con seis caguamas te sale bien esa rola!",
  "genre_banda_14": "¡Si fueras del Recodo, ya te habrían regresado al rancho!",
  "genre_ranchera_10": "¡Ese mariachi ya pidió asilo político en otro lado!",
  "genre_ranchera_11": "¡Hasta los agaves se secaron con ese falsete!",
  "genre_ranchera_12": "¡Le echaste más crema que a los tacos, pero sin sabor!",
  "genre_ranchera_13": "¡Don Chente desde el cielo te está mandando un rayo!",
  "genre_ranchera_14": "¡Se me rompió el jarrito de barro de puro dolor auditivo!",
  "genre_rock_10": "¡Ni Metallica en sus peores días sonaba tan destructivo!",
  "genre_rock_11": "¡El único rock que haces es cuando te tropiezas con una piedra!",
  "genre_rock_12": "¡Rompiste la guitarra, el bajo, y mis tímpanos de paso!",
  "genre_rock_13": "¡Ese solo vocal sonó a frenazo de camión de basura!",
  "genre_rock_14": "¡Axl Rose te mandó saludos... y una orden de restricción!",
  "genre_pop_10": "¡Más desafinado que corista de quinceañera!",
  "genre_pop_11": "¡Esa coreografía estuvo chida, lástima que estamos calificando la voz!",
  "genre_pop_12": "¡Hasta Timbiriche te hubiera sacado del grupo!",
  "genre_pop_13": "¡Cantaste tan fresa que me dio alergia musical!",
  "genre_pop_14": "¡Belinda ya se desmayó de escuchar eso, y no por el sapito!",
  "genre_cumbia_10": "¡Ese pasito tun tun te salió más bien pasito pum pum!",
  "genre_cumbia_11": "¡Si esto fuera un sonidero, ya te hubieran desconectado la bocina!",
  "genre_cumbia_12": "¡Traes la cumbia en las venas, pero la circulación tapada!",
  "genre_cumbia_13": "¡Celso Piña estaría tocando el acordeón... para no oírte!",
  "genre_cumbia_14": "¡Qué cumbión tan mareador, me dio vértigo de lo mal que sonó!",
  "genre_balada_10": "¡Lloré, pero porque me acordé que todavía faltan más por cantar!",
  "genre_balada_11": "¡Ese drama no lo compra ni TV Azteca!",
  "genre_balada_12": "¡Cristian Castro te manda sus alas para que vueles lejos del micro!",
  "genre_balada_13": "¡Te dolió tanto la rola que hasta el aire te faltó, mijo!",
  "genre_balada_14": "¡Pura cortavenas, pero de las que infectan!",
  "genre_electronica_10": "¡Ese sintetizador sonó como gato peleando en el techo!",
  "genre_electronica_11": "¡La rola era house pero nos dejaste a todos out!",
  "genre_electronica_12": "¡Ni Skrillex se atrevería a soltar ese ruido tan random!",
  "genre_electronica_13": "¡Parecía que se te quedó trabado el teclado de la computadora!",
  "genre_electronica_14": "¡Mucho punchis punchis, pero el talento andaba en el baño!",
  "genre_default_10": "¡Ni Google Translate entiende lo que acabas de cantar!",
  "genre_default_11": "¡Qué valor, qué coraje, qué falta de talento!",
  "genre_default_12": "¡Esto es un karaoke, no un concurso de gritos en el mercado!",
  "genre_default_13": "¡Me duelen los oídos, los ojos y la dignidad!",
  "genre_default_14": "¡Otra así y mejor desconecto el servidor!",
  "intro_10": "¡Pásale a lo barrido, que aquí no hay piedad!",
  "intro_11": "¡Agarra el micrófono como si fuera tu última caguama!",
  "intro_12": "¡Demuestra que esos años cantando en la regadera valieron la pena!",
  "intro_13": "¡El que sigue! Que no tiemblen las corvas.",
  "intro_14": "¡Prepárense para una obra maestra... o para el fin del mundo!",
  "vote_100_7": "¡Pónganle una estatua a este compa en su barrio!",
  "vote_100_8": "¡Impecable! ¡Sublime! ¡Te quiero mucho!",
  "vote_100_9": "¡De aquí directo a llenar el Foro Sol!",
  "vote_60_7": "¡Suficiente para aprobar la materia, pero sin honores!",
  "vote_60_8": "¡Cantaste como en martes ni muy muy, ni tan tan!",
  "vote_60_9": "¡Hubo fallas técnicas, pero la actitud te salvó de milagro!",
  "vote_30_7": "¡De panzazo y rozando la tragedia, carnal!",
  "vote_30_8": "¡Traías el volumen al cien pero el talento en modo avión!",
  "vote_30_9": "¡Se agradece la participación, ahora siéntate por favor!",
  "vote_10_7": "¡Por favor, que alguien llame a control de animales!",
  "vote_10_8": "¡Mis respetos... por tener el valor de hacer el ridículo así!",
  "vote_10_9": "¡Ni con autotune divino se arregla ese desastre!",

  // ── MODES FLOW ──
  "modes_welcome_0": "¡Bienvenidos a Rítmika, banda! Les tengo varios modos para que se la pasen increíble. El Clásico es la experiencia completa con ruleta, canciones variadas y mucha carrilla. Anime es puro opening para los otakus. Ranchera es para los despechados con mariachi incluido. Nostalgia te lleva a los 2000s con tu discman y tu lado emo. Y Emo... bueno, para los intensos. ¡Elijan su modo y vamos a arrancar esta fiesta!",
  "modes_welcome_1": "¡Qué onda, banda! Bienvenidos a Rítmika, el karaoke más loco del palenque. Miren, les tengo el Modo Clásico que es la experiencia completa: ruleta, canciones de todos los géneros y mucha carrilla. Si son otakus, ahí está el modo Anime con puros openings. Si traen despecho, modo Ranchera con puro mariachi. Los nostálgicos tienen el modo Nostalgia pa' los 2000s, y los intensos su modo Emo. ¡Elijan el suyo y que empiece la fiesta!",
  "modes_welcome_2": "¡Llegaron, llegaron! Bienvenidos a Rítmika, el show de karaoke más escandaloso de la cuadra. Antes de arrancar, elijan su modo de sufrimiento. El Clásico es para valientes, con ruleta y de todos los géneros. Anime es puro opening, Ranchera es puro despecho, Nostalgia es pa' los 2000s, y Emo... bueno, para los que traen el alma rota. ¡A elegir y a cantar!",
  "modes_welcome_3": "¡Buenas noches, palenque! El Tío Axolo les trae la bienvenida más calurosa. Aquí tenemos varios modos pa' que cada quien sufra a su manera. El Clásico tiene de todo, Anime es pa' los otakus, Ranchera es pa' los despechados, Nostalgia te lleva a los 2000s, y Emo es pa' los intensos. ¡Eligan el suyo y que empiece el sufrimiento!",
  "modes_welcome_4": "¡Arrancamos la noche, banda! Bienvenidos a Rítmika, donde cantar es opcional pero el ridículo es obligatorio. Miren, les tengo varios modos: el Clásico es la experiencia completa, Anime es puro opening, Ranchera es puro mariachi, Nostalgia te lleva a los 2000s, y Emo es para los que traen el fleco tapando un ojo. ¡Eligan su modo y a sufrir!",
  "modes_welcome_5": "¡Bien, bien, bien! Bienvenidos a Rítmika, el karaoke donde la amistad se pone a prueba. Les tengo varios modos pa' que elijan cómo quieren pasarla. El Clásico es el clásico de siempre, Anime es pa' los que ven dibujos japoneses, Ranchera es pa' los despechados, Nostalgia te transporta a los 2000s, y Emo es pa' los dramáticos. ¡A elegir!",
  "modes_welcome_6": "¡Qué tal, qué tal! Bienvenidos al palenque de Rítmika. Soy el Tío Axolo y les vengo a explicar los modos de juego. Tenemos el Clásico que es la experiencia completa con ruleta y todo. Anime para los otakus, Ranchera para los despechados, Nostalgia para los nostálgicos de los 2000s, y Emo para los que lloran con la lluvia. ¡Eligan y arrancamos!",
  "modes_welcome_7": "¡Bienvenidos, bienvenidos! Rítmika está listo para la fiesta y el Tío Axolo tiene varios modos pa' que elijan. El Clásico es para los que quieren la experiencia completa, Anime es puro opening y neón, Ranchera es puro dolor y mariachi, Nostalgia te lleva a los 2000s con tu Discman, y Emo es para los intensos del alma. ¡Eligan su modo y que no empiece el llanto!",
  "modes_welcome_8": "¡Aquí estamos otra vez, banda! Bienvenidos a Rítmika, donde la voz se premia y el ridículo se castiga... o al revés. Les tengo varios modos: el Clásico tiene ruleta y canciones de todos lados, Anime es pa' los que hablan en gallo japonés, Ranchera es pa' los que traen despecho, Nostalgia es pa' los del 2000s, y Emo es pa' los que se escuchan tristes en el espejo. ¡A elegir!",
  "modes_welcome_9": "¡Wepa, wepa! Bienvenidos a Rítmika, el karaoke más loco de toda la colonia. El Tío Axolo les presenta los modos de juego. El Clásico es la experiencia completa con ruleta, Anime es puro opening, Ranchera es puro despecho, Nostalgia te lleva a los 2000s, y Emo es para los que traen el delineador puesto. ¡Eligan su modo y que arranque la fiesta!",
  "mode_intro_0": "¡Bienvenidos! Antes de entrar al palenque, ¿de qué humor venimos hoy?",
  "mode_intro_1": "¡Qué onda! Elige cómo quieres sufrir esta noche.",
  "mode_intro_2": "¡Llegó la hora de elegir el ambiente! Seleccionen con sabiduría.",
  "mode_selected_clasico": "¡Modo clásico! Como debe ser, sin llorar y con tequila.",
  "mode_selected_anime": "¡Modo Otaku activado! Saquen las katanas y los gallos en japonés.",
  "mode_selected_emo": "¡Modo Emo! A cortarse las venas y llorar por la ex.",
  "mode_selected_ranchera": "¡Modo Ranchero! A sacar el sombrero y cantar con despecho.",
  "mode_selected_nostalgia": "¡Modo Nostalgia! Puros clásicos que duelen en el alma.",

  // ── NEW EXTRA GENRE BARKS 15-19 ──
  "genre_reggaeton_15": "¡Traes el ritmo en la sangre, pero la sangre de horchata!",
  "genre_reggaeton_16": "¡Eso fue un perreo galáctico, nos mandaste a volar de lo feo!",
  "genre_reggaeton_17": "¡Mejor dedícate a otra cosa, el dembow no te quiere!",
  "genre_reggaeton_18": "¡Ese autotune pide a gritos la jubilación anticipada!",
  "genre_reggaeton_19": "¡Ni Maluma baby se atrevería a soltar ese desastre!",
  "genre_banda_15": "¡Con ese ritmo espantaste hasta a las moscas del establo!",
  "genre_banda_16": "¡Suena a banda del recodo... pero en un simulacro de sismo!",
  "genre_banda_17": "¡Te juro que la tambora lloró cuando empezaste a cantar!",
  "genre_banda_18": "¡Ay dolor! Ya me volviste a dar, pero en los tímpanos.",
  "genre_banda_19": "¡El sombrero te queda grande y la canción también, compa!",
  "genre_ranchera_15": "¡Por tu culpa el mariachi loco quiere dejar de bailar!",
  "genre_ranchera_16": "¡Traes dolor, traes despecho, pero te falta garganta!",
  "genre_ranchera_17": "¡Pobre caballo blanco, de escucharte ya no quiso correr!",
  "genre_ranchera_18": "¡Ese grito de mariachi sonó a llanta frenando en seco!",
  "genre_ranchera_19": "¡Un tequilazo doble para el público, que esto duele!",
  "genre_rock_15": "¡El espíritu del rock and roll está pidiendo auxilio!",
  "genre_rock_16": "¡Tanto ruido y tan poca música, parece microbús sin escape!",
  "genre_rock_17": "¡Eso fue heavy metal... pero pesado de aguantar!",
  "genre_rock_18": "¡Ni rompiendo la guitarra salvas esa presentación!",
  "genre_rock_19": "¡Los decibeles al máximo y la afinación en negativo!",
  "genre_pop_15": "¡Pop latino, de ese que te hace cambiar de estación!",
  "genre_pop_16": "¡Súper fresa, lástima que la fresa venía pasada!",
  "genre_pop_17": "¡Ni todos los brillos del mundo tapan esos gallos!",
  "genre_pop_18": "¡Qué bonito bailas, ojalá cantaras la mitad de bien!",
  "genre_pop_19": "¡Ese agudo rompió tres copas y dos amistades!",
  "genre_cumbia_15": "¡Baila la cumbia... y mejor no cantes la cumbia!",
  "genre_cumbia_16": "¡Ese güiro tiene más ritmo que tus cuerdas vocales!",
  "genre_cumbia_17": "¡Nos pusiste a sudar, pero de puro nervio al escucharte!",
  "genre_cumbia_18": "¡La pista está llena, pero todos huyendo del sonido!",
  "genre_cumbia_19": "¡Sabor tropical que se quedó en el refrigerador!",
  "genre_balada_15": "¡Tanto drama que ya me siento en el capítulo final!",
  "genre_balada_16": "¡Cantas al desamor, pero enamoras a la desgracia!",
  "genre_balada_17": "¡Traigan los pañuelos, que mis oídos están sangrando!",
  "genre_balada_18": "¡Esa lágrima fue real, pero de dolor físico al oírte!",
  "genre_balada_19": "¡Una balada que pasará a la historia como arma letal!",
  "genre_electronica_15": "¡Apaguen esa consola, que huele a cable quemado!",
  "genre_electronica_16": "¡Mucho láser, mucho humo, cero talento musical!",
  "genre_electronica_17": "¡Ese beat estuvo tan raro que se me reinició el Windows!",
  "genre_electronica_18": "¡Rave de pesadilla, de aquí al psicólogo todos!",
  "genre_electronica_19": "¡La máquina hace la mitad del trabajo y ni así pudiste!",
  "genre_default_15": "¡Un talento oculto... y mejor que siga bien escondido!",
  "genre_default_16": "¡El micrófono acaba de meter una demanda por abuso!",
  "genre_default_17": "¡Cantas con el alma, porque con la voz de plano no!",
  "genre_default_18": "¡Una actuación inolvidable, aunque queramos olvidarla!",
  "genre_default_19": "¡Te mereces un aplauso, pero en la cara y con una silla!",

  // ── NEW EXTRA SINGER INTROS 15-19 ──
  "intro_15": "¡Que pase el desgraciado al micrófono!",
  "intro_16": "¡Prepárense para la destrucción masiva de sus oídos!",
  "intro_17": "¡Atención! Evacuen la sala o aguanten como los machos.",
  "intro_18": "¡Llegó la hora! Demuestra que sí sabes leer la letra.",
  "intro_19": "¡Al frente! Y que el dios del karaoke se apiade de ti.",

  // ── NEW EXTRA VOTE REACTIONS ──
  "vote_100_10": "¡Una verdadera joya auditiva, mis respetos!",
  "vote_100_11": "¡Estás para cantar en el Super Bowl, compadre!",
  "vote_100_12": "¡Se me puso la piel de gallina, pero de la buena!",
  "vote_100_13": "¡Cantas como los ángeles, ojalá no te me vayas pronto!",
  "vote_100_14": "¡Oro molido! ¡Este compa sí trae con qué defenderse!",
  "vote_60_10": "¡Ahí la llevas, con unas clases más la armas!",
  "vote_60_11": "¡Sobreviviste a la crítica, puedes respirar tranquilo!",
  "vote_60_12": "¡Se agradece el intento, aunque haya sido regular!",
  "vote_60_13": "¡Ni bien ni mal, pasaste de incógnito por el escenario!",
  "vote_60_14": "¡Una actuación tibia, como agua de tinaco en la tarde!",
  "vote_30_10": "¡Mejor cómprate el disco y deja de sufrir!",
  "vote_30_11": "¡Casi la logras... casi logras que me vaya de aquí!",
  "vote_30_12": "¡Híjole, creo que desafinaste hasta el silencio!",
  "vote_30_13": "¡Tu voz tiene futuro... pero en otro sistema solar!",
  "vote_30_14": "¡Échale más enjundia, que pareces zombi cantando!",
  "vote_10_10": "¡Eso fue un atentado directo contra la música!",
  "vote_10_11": "¡Si el ruido matara, ya estaríamos todos tiesos!",
  "vote_10_12": "¡Llamen a la policía, hubo un asesinato musical!",
  "vote_10_13": "¡Me duelen partes del cuerpo que ni sabía que tenía!",
  "vote_10_14": "¡Qué asco, y no me refiero a los tomates que te aventaron!"
};
